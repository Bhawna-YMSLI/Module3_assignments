...
public class BookController {
	...
	public List<BookDto> getByAuthor(@PathVariable Double price) {
	...
	public List<BookDto> getByKeywordInTitle(@PathVariable String keyword) {
		return service.getByKeywordInTitle(keyword);
	}

	// Native query test (price range)
	// GET /api/books/price-range?min=100&max=500
	@GetMapping("/price-range")
	public List<BookDto> getBooksInPriceRange(@RequestParam Double min, @RequestParam Double max) {
